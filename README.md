...
When you're setting up a project, you need to not only create the git repository for that project, but also a repository for its releases.  (Hopefully this doesn't surprise you too much.)
